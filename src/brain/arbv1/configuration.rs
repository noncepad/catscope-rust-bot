//! Runtime configuration populated from the Go brain via stdin messages.
//! The wallet field is set once when `KeyFlagWallet` is received; the mint IDs
//! are fixed constants (wSOL and USDC). max_slippage caps swap price impact.
